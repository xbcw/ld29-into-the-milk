...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("graphics/plane.png",loader10);
	ApplicationMain.total++;
	var loader11 = new flash.display.Loader();
	ApplicationMain.loaders.set("graphics/player.png",loader11);
	ApplicationMain.total++;
...
entities.Player = function(x,y) {
	com.haxepunk.Entity.call(this,x,y);
	this.set_graphic(com.haxepunk.graphics.Image.createRect(32,32,14544639));
	this.width = 32;
	this.height = 32;
	this.originX = 0;
	this.originY = 0;
...
entities.Player.prototype = $extend(com.haxepunk.Entity.prototype,{
	handleInput: function() {
		this.acceleration = 0;
		if(com.haxepunk.utils.Input.check("up")) this.acceleration = -1;
		if(com.haxepunk.utils.Input.check("down")) this.acceleration = 1;
	...
	,move: function() {
		...
		if(Math.abs(this.velocity) > 8) this.velocity = 8 * com.haxepunk.HXP.sign(this.velocity);
...
scenes.GameScene.prototype = $extend(com.haxepunk.Scene.prototype,{
	begin: function() {
		this.add(new entities.Player(16,com.haxepunk.HXP.halfHeight));
		this.spawn();
	}
	,update: function() {
	...
	,spawn: function() {
		...
		this.add(new entities.Enemy(com.haxepunk.HXP.width,y));
...
//# sourceMappingURL=BreakTheRobots.js.map