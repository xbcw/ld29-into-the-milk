...
class World8 extends World
{
	public function new(player:entities.Player)
	{
		...
		add(new Cookie(1750,3500, new Image("graphics/mmcookielarge.png")));
	...
	{
	  // create the map
	  var e = new TmxEntity("maps/world8.tmx");
