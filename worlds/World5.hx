...
class World5 extends World
{
	public function new(player:entities.Player)
	{
		...
		add(new Cookie(1650, 3650, new Image("graphics/mmcookielarge.png")));
	...
	{
	  // create the map
	  var e = new TmxEntity("maps/world5.tmx");
